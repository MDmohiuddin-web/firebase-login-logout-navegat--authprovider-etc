...
const Log_in = () => {
  const { signInuser,sininwidthgoogle,githubsingin } = useContext(AuthContext);
  ...
  return (
    <div>
      <div className="w-full max-w-md m-auto p-8 space-y-3 rounded-xl bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
        ...
        <div className="flex justify-center space-x-4">
          ...
          <button onClick={githubsignin} aria-label="Log in with Twitter" className="p-3 rounded-sm">
          <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="w-5 h-5 fill-current"
